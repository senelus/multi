...
# Время выполнения программы при параллельном выполнении 8.939356327056885 при 1 тредов
# Время выполнения программы при параллельном выполнении 3.6746127605438232 при 5 тредов
# Время выполнения программы при параллельном выполнении 3.5990450382232666 при 10 тредов
# Время выполнения программы при параллельном выполнении 3.601682662963867 при 100 тредов